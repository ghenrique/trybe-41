...
<html class="no-js" lang="pt-br">
	<head>
		<meta charset="utf-8" />
		<title>Felipe Ferreira | Professores</title>
		...
		<div class="content" role="main">
			...
			<section class="hero">
				...
				<figure class="hero__image">
					...
					<img src="../dist/images/teachers/felipe-ferreira.jpg" alt="Conheça nossos professores">
			...
			<section class="about about--teachers">
				...
				<div class="wrapper">
					...
					<p class="about__description">
						<span>Felipe Ferreira, Curitiba</span>
						 Professor com experiência no ensino particular de inglês, já trabalhou como tradutor em processos de negociações empresariais. Possui certificação avançada em inglês com o TOEIC. É músico e ama literatura.
					</p>
			...
			<section class="pricing">
				...
				<div class="wrapper">
					...
					<div class="pricing__item pricing__values">
						<p class="pricing__class-hour">R$ 44,62 hora/aula</p>

						<div class="pricing__plan">
							<h2>Plano mensal</h2>
							<p>1 hora/semana - R$ 179,16</p>
							<p>2 horas/semana - R$ 356,96</p>
						</div>

						<div class="pricing__plan">
							<h2>Plano quadrimestral</h2>
							<p>1 hora/semana - 6x de R$ 142,53</p>
							<p>2 horas/semana - 6x de R$ 285,07</p>
						</div>
					</div>
					<!-- / .pricing__values -->
		...
		<div class="modal">
			...
			<div class="modal__content">
				...
				<header class="modal__header">
					...
					<!-- .wrapper -->
					<div class="wrapper">
						<h2>Marcar café com Felipe Ferreira</h2>
				...
				<section class="modal__section">
					...
					<div class="wrapper">
						...
						<form action="#sucesso" method="POST" class="modal__form">
							...
							<input type="hidden" name="professor" value="Felipe Ferreira">
